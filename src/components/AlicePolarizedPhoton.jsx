...
export default function AlicePolarizedPhoton({
  aliceBasis,
  alicePhoton,
  withEve,
}) {
  return (
    <div
      className={`${
        withEve ? "animate-alice-down-slide-w-eve" : "animate-alice-down-slide"
      } `}
    >
      <svg
        version="1.1"
        ...
        <g>
          <g>
            <circle
              ...
              r="50.8"
            />
            {parseInt(aliceBasis) === 0 && parseInt(alicePhoton) === 1 && (
              <>
                {/* Top */}
            ...
            {parseInt(aliceBasis) === 0 && parseInt(alicePhoton) === 0 && (
              <>
                {/* Left */}
                <path
            ...
            {parseInt(aliceBasis) === 1 && parseInt(alicePhoton) === 0 && (
              <>
                {/* Top Left */}
                <path
            ...
            {parseInt(aliceBasis) === 1 && parseInt(alicePhoton) === 1 && (
              <>
                {/* Bottom Left  */}
                <path
