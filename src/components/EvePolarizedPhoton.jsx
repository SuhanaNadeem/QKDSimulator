...
export default function EvePolarizedPhoton({
  eveBasis,
  alicePhoton,
  aliceBasis,
  evePhoton,
  ...
  return (
    <div className="animate-eve-down-slide">
      <svg
        version="1.1"
        id="Layer_1"
      ...
      >
        <g>
          <g>
            <circle
              className="bg-green-300 fill-current text-green-700 animate-pulse"
              cx="244.963"
              cy="244.925"
              r="50.8"
            />
            {((parseInt(eveBasis) === 0 &&
              parseInt(aliceBasis) === 0 &&
              parseInt(alicePhoton) === 1) ||
              (parseInt(eveBasis) === 0 &&
                parseInt(aliceBasis) === 1 &&
                parseInt(evePhoton) === 1)) && (
              <>
                {/* Top */}
            ...
            {((parseInt(eveBasis) === 0 &&
              parseInt(aliceBasis) === 0 &&
              parseInt(alicePhoton) === 0) ||
              (parseInt(eveBasis) === 0 &&
                parseInt(aliceBasis) === 1 &&
                parseInt(evePhoton) === 0)) && (
              <>
                {/* Left */}
                <path
